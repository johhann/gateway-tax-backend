    ...
    <div role="article" aria-roledescription="email" aria-label lang="en">
        <section
            ...
            <main style="padding: 32px; text-align: center;">
                <h2 style="color: #222; font-size: 24px; margin-bottom: 12px;">Verify Your Email Address</h2>
                <p style="font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
                    Hi {{ $user->name }}, <br><br>
                    To secure your account, please verify your email using the code below.
                </p>
                ...
                <div style="margin: 24px 0;">
                    ...
                    <p style="font-size: 14px; color: #555; margin-top: 12px;">
                        Enter this 4-digit code in the verification page to confirm your email.
                    </p>
                </div>

                <p style="font-size: 14px; color: #555; line-height: 1.6;">
                    This code will expire in <strong>{{ config('verify.ttl') }} minutes</strong>.
