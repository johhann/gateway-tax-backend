    ...
    <div role="article" aria-roledescription="email" aria-label lang="en">
        <section
            ...
            <main style="padding: 32px; text-align: center;">
                <h2 style="color: #222; font-size: 24px; margin-bottom: 12px;">Tax Request Ready for Pickup</h2>
                <p style="font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
                    Hi {{ $taxRequest->full_name ?? 'Customer' }}, <br><br>
                    Your tax request has been marked as ready for pickup.
                </p>

                <p style="font-size: 14px; color: #555; line-height: 1.6;">
                    If you have questions about pickup times or location, please contact our support team.
                </p>
